...
const require_authorization = require('../authorization-CJB1hjGu.js');
const require_error = require('../error-DyScPmkp.js');
...
const require_organization = require('../organization-CdNRqdLj.js');
...
function useSubscription(params) {
	...
	const swr$1 = (0, swr.default)((params?.enabled ?? true) && billingEnabled ? {
...
const StripeLibsProvider = ({ children }) => {
	const clerk = useClerk();
	const { data: stripeClerkLibs } = (0, swr.default)("clerk-stripe-sdk", async () => {
	...
	return /* @__PURE__ */ react.default.createElement(StripeLibsContext.Provider, { value: { value: stripeClerkLibs || null } }, children);
};
...
const usePaymentSourceUtils = (forResource = "user") => {
	...
	const { data: initializedPaymentMethod, trigger: initializePaymentMethod } = (0, swr_mutation.default)({
	...
	const { data: stripe } = (0, swr.default)(stripeClerkLibs && externalGatewayId && stripePublishableKey ? {
		key: "stripe-sdk",
		externalGatewayId,
...
const PaymentElementProvider = ({ children,...props }) => {
	return /* @__PURE__ */ react.default.createElement(StripeLibsProvider, null, /* @__PURE__ */ react.default.createElement(PropsProvider, props, /* @__PURE__ */ react.default.createElement(PaymentElementInternalRoot, null, children)));
};
