...
import { validateReverificationConfig } from "../authorization-XX4mKaAz.mjs";
import { ClerkRuntimeError, isClerkAPIResponseError } from "../error-74EhajFh.mjs";
...
import { getCurrentOrganizationMembership } from "../organization-D9SEGukq.mjs";
import { eventMethodCalled } from "../telemetry-wqMDWlvR.mjs";
import React, { useCallback, useEffect, useMemo, useRef, useState, useSyncExternalStore } from "react";
import useSWR, { SWRConfig, default as useSWR$1 } from "swr";
...
function useSubscription(params) {
	...
	const swr = useSWR$1((params?.enabled ?? true) && billingEnabled ? {
...
const StripeLibsProvider = ({ children }) => {
	...
	return /* @__PURE__ */ React.createElement(StripeLibsContext.Provider, { value: { value: stripeClerkLibs || null } }, children);
};
...
const PaymentElementProvider = ({ children,...props }) => {
	return /* @__PURE__ */ React.createElement(StripeLibsProvider, null, /* @__PURE__ */ React.createElement(PropsProvider, props, /* @__PURE__ */ React.createElement(PaymentElementInternalRoot, null, children)));
};
